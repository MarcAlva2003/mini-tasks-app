  ...
  return (
    <section className="w-full mt-20 lg:mt-0 lg:h-[calc(100vh-64px)] flex flex-col justify-center">
      <div className="">
        ...
        <p className='text-sm leading-[24px] mb-12 lg:mb-8 md:text-center lg:text-left'>This is a list of recent projects I´ve collaborated on or I´ve done myself</p>
      </div>
